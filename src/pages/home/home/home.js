          ...
          <div className='home-header'>
            <div className='home-header-texts'>
              ...
              <div className='home-header-buttons'>
                  <button className='home-header-button-fill' onClick={executeScroll}>Learn More</button>
                  <button className='home-header-button-outline' onClick={() => window.open('/about')}>Get Started</button>
              </div>
            </div>
          </div>
        </div>
